        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid md:grid-cols-2 gap-10 lg:gap-16 items-start">
                <div
                    ...
                    <h3 class="text-xl md:text-2xl font-bold text-green-custom mb-6">For Mill Factories</h3>
                    ...
                    <form class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="mill_annual_sales" name="mill_annual_sales"
                                class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-custom focus:border-transparent">
                        </div>
                        <div>
                            <label for="mill_desired_price"
                                class="block text-sm font-medium text-gray-700 mb-1">Desired Sales Price
                                (USD/ton)</label>
                            <input type="text" id="mill_desired_price" name="mill_desired_price"
                                class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-custom focus:border-transparent">
                        </div>
                        <div>
                            <label for="mill_years_operation"
                                class="block text-sm font-medium text-gray-700 mb-1">Years in Operation</label>
                            <input type="text" id="mill_years_operation" name="mill_years_operation"
                                class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-custom focus:border-transparent">
                        </div>
                        <div>
                            <label for="mill_contact_name"
                        ...
                        <div>
                            <label for="mill_contact_phone"
                                class="block text-sm font-medium text-gray-700 mb-1">Contact Person Phone
                                Number</label>
                ...
                <div
                    class="bg-white p-6 md:p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <h3 class="text-xl md:text-2xl font-bold text-green-custom mb-6">For Collectors</h3>
                    <p class="text-gray-700 leading-relaxed mb-6">
                    ...
                    <form class="space-y-4">
                        ...
                        <div>
                            <label for="collector_monthly_volume"
                                class="block text-sm font-medium text-gray-700 mb-1">Monthly Collected Volume
                                (ton/month)</label>
                            <input type="text" id="collector_monthly_volume" name="collector_monthly_volume"
                                class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-custom focus:border-transparent">
                        </div>
                        <p class="block text-sm font-medium text-gray-700 pt-2">Palm Variety Composition (%)</p>
                        <div class="grid grid-cols-3 gap-4">
                        ...
                        <div>
                            <label for="collector_annual_sales"
                                class="block text-sm font-medium text-gray-700 mb-1">Annual Sales Record
                                (ton/year)</label>
